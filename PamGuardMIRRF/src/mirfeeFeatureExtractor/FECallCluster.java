...
/**
 * MIRFEE sorts contours into "call clusters". Any contours within the
...
public class FECallCluster implements Serializable, Cloneable {
	...
	public long[] uids;
	public String[] locations; // only used with .mtsf as input
	public long[] datetimes;
	public int[] durations;
	public int[] lfs;
	public int[] hfs;
	public String[] labels; // only used with .mtsf as input
