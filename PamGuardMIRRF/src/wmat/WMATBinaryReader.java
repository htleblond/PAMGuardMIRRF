 ...
 */
public class WMATBinaryReader extends BinaryInputStream {
	...
	public WMATBinaryReader(WMATControl wmatControl, String filename, WhistleToneConnectProcess wmDetector) {
...
//			}
			...
			for (int i = 0; i < nSlices; i++) {
				...
				sliceData = new WMATSliceData(sliceNum, firstSliceSample + 
