 ...
 */
@Deprecated
public class WMATTimeZonePanel extends JPanel {
	
	protected JComboBox<String> audioBox;
	protected JComboBox<String> binaryBox;
	protected JComboBox<String> databaseBox;
	
	public WMATTimeZonePanel(boolean includeAudio, boolean includeBinary, boolean includeDatabase, boolean addBorder) {
