...
public class LCAlarmDialog extends PamDialog {
	...
	protected LCAlarmDialog(Window parentFrame, LCControl lcControl, LCAlarmParameters alarmParams) {
		...
		c.gridy++;
		c.gridx = 0;
		secondPanel.add(new JLabel("Min. lead"), c);
		c.gridx++;
		minLeadBox = new JComboBox<String>(new String[] {"Very low", "Low", "Average", "High", "Very high"});
		minLeadBox.setSelectedItem(alarmParams.minLead);
		secondPanel.add(minLeadBox, c);
	...
	public boolean getParams() {
		...
		alarmParams.minLead = (String) minLeadBox.getSelectedItem();
		return true;
	}
	...
	public void restoreDefaultSettings() {
		...
		minDetectionsField.setText("1");
		minLeadBox.setSelectedItem("Very low");
	}
