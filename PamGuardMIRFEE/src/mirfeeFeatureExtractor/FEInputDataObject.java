...
public class FEInputDataObject implements Serializable {
	...
	public boolean isMTSF;
	
	public String clusterID; // .mtsf only
	public long uid;
	public String location; // .mtsf only
	public String datetime;
	public int duration;
	public int amplitude; // .wmat only
	public int lf;
	public int hf;
	public String label;
	public double[][] slicedata; // .wmat only
	public HashMap<String, Double> problematicFeatures; // .mtsf only
	
	public FEInputDataObject(String[] data, boolean isMTSF, ArrayList<String> foundFeatures, ArrayList<String> foundProblematicFeatures)
