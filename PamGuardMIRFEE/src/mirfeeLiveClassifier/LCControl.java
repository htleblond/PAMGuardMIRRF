...
/**
 * The controller class for the MIRFEE Live Classifier.
 * @author Holly LeBlond
 */
public class LCControl extends MIRFEEControlledUnit implements PamSettings {
	
	public static final String UNITTYPE = "MIRFEELC";
